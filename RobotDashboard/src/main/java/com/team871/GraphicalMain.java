...
import com.team871.screens.preconfigured.TestScreen;
...
public class GraphicalMain extends Application {
    ...
    public void init() {
        ...
        driveScreen = new TestScreen(dashboardConfig);
        ...
        Task task = new Task<Void>() {//update thread.
            ...
            public Void call() throws Exception {
                ...
                while (true) {
                    ...
                    System.out.println(Math.max((((goalT) - (System.currentTimeMillis() - startT))), 0));
